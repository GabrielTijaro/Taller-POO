...
public class Ejercicio10 {
    public static void main(String[] args) {
        Cliente cliente = new Cliente("Sofia Ramirez", "sofia@correo.com", "1023456789");
        Compra compra = new Compra(501, "2026-07-31", cliente);
        compra.agregarProducto(new ProductoCompra("Teclado", 80000, 1));
        compra.agregarProducto(new ProductoCompra("Mouse", 35000, 2));
